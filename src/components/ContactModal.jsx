      ...
      <ModalContent bg={useColorModeValue('white', 'rgb(36 41 47)')} rounded="xl" p="0">
        <ModalBody py="12" px={{ base: 8, md: 12 }}>
          ...
          <SimpleGrid columns={{ base: 3, md: 3 }} spacing={{ base: 3, md: 4 }}>
            <Flex
              onClick={() => handleClick('Email', 'mailto:osomhe.aleogho@gmail.com')}
            ...
            <Flex
              onClick={() => handleClick('Github', 'https://github.com/Osomhe1')}
              direction="column" align="center" border="1px solid" cursor="pointer"
              borderColor={useColorModeValue("blackAlpha.200", "whiteAlpha.200")} rounded="2xl" px="8"
              py={{ base: 8, md: 10 }}
              _hover={{ bg: useColorModeValue('blackAlpha.50', 'whiteAlpha.50') }}
            ...
            <Flex
              onClick={() => handleClick('Telegram', 'https://t.me/osomzi')}
              direction="column" align="center" border="1px solid" cursor="pointer"
              borderColor={useColorModeValue("blackAlpha.200", "whiteAlpha.200")} rounded="2xl" px="8"
              py={{ base: 8, md: 10 }}
              _hover={{ bg: useColorModeValue('blackAlpha.50', 'whiteAlpha.50') }}
            ...
            <Flex
              onClick={() => handleClick('Linkedin', 'https://www.linkedin.com/in/osomhe-aleogho-8396861a6/')}
              direction="column" align="center" border="1px solid" cursor="pointer"
              borderColor={useColorModeValue("blackAlpha.200", "whiteAlpha.200")} rounded="2xl" px="8"
              py={{ base: 8, md: 10 }}
              _hover={{ bg: useColorModeValue('blackAlpha.50', 'whiteAlpha.50') }}
            ...
            <Flex
              onClick={() => handleClick('Twitter', 'https://twitter.com/osomhealeogho')}
              direction="column" align="center" border="1px solid" cursor="pointer"
              borderColor={useColorModeValue("blackAlpha.200", "whiteAlpha.200")} rounded="2xl" px="8"
              py={{ base: 8, md: 10 }}
              _hover={{ bg: useColorModeValue('blackAlpha.50', 'whiteAlpha.50') }}
